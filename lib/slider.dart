...
class SlidingUpPanel extends StatefulWidget {
  ...
  final VoidCallback? onPanelSnapPoint;
...
class _SlidingUpPanelState extends State<SlidingUpPanel>
  ...
  void initState() {
    ...
    _ac = new AnimationController(
      ...
      ..addListener(() {
        ...
        if (widget.onPanelSnapPoint != null && _ac.value == widget.snapPoint)
          widget.onPanelSnapPoint!();
  ...
  bool get _isPanelMiddle => _ac.value == 0.87;
